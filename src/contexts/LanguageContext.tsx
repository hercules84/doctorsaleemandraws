...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "hero.workingHoursValue": "Daily 3:00 PM - 9:00 PM (Except Friday)",
    "hero.location": "Location",
    "hero.locationValue": "Qazi Mohammad Road, Duhok",
    ...
    "contact.address": "Qazi Mohammad Road, Duhok, Duhok Governorate, 42001, Iraq",
    "contact.workingHours": "Working Hours",
    "contact.workingHoursValue": "Daily 3:00 PM - 9:00 PM (Except Friday)",
    "contact.whatsapp": "WhatsApp & Appointments",
    "contact.emergencyPhone": "Emergency Dental Line",
    "contact.emergencyNote": "For urgent dental concerns",
    ...
    "contact.formDescription": "Complete the form and your email app will prepare an enquiry for our clinic.",
    "contact.formName": "Full Name",
    "contact.formNamePlaceholder": "Enter your full name",
    "contact.formEmail": "Email Address",
    "contact.formEmailPlaceholder": "Enter your email address",
    ...
    "contact.formSubmit": "Prepare Email",
    "contact.formNote": "This form opens your email app and addresses the message to dr.saleemo@gmail.com.",
    "contact.formPrepared": "Your email app should now be ready with your message.",
    ...
    "faq.a5": "For appointments, use our website booking form or WhatsApp at 07507816500. For urgent dental concerns, call 07781665000 during clinic hours.",
  ...
  ar: {
    ...
    "hero.workingHoursValue": "يومياً ٣:٠٠ - ٩:٠٠ مساءً (عدا الجمعة)",
    "hero.location": "الموقع",
    "hero.locationValue": "شارع قاضي محمد، دهوك",
    ...
    "contact.address": "شارع قاضي محمد، دهوك، محافظة دهوك، ٤٢٠٠١، العراق",
    "contact.workingHours": "ساعات العمل",
    "contact.workingHoursValue": "يومياً ٣:٠٠ - ٩:٠٠ مساءً (عدا الجمعة)",
    "contact.whatsapp": "واتساب وحجز المواعيد",
    "contact.emergencyPhone": "هاتف الحالات الطارئة للأسنان",
    "contact.emergencyNote": "للحالات العاجلة المتعلقة بالأسنان",
    ...
    "contact.formDescription": "أكمل النموذج وسيجهز تطبيق البريد الإلكتروني رسالة لعيادتنا.",
    "contact.formName": "الاسم الكامل",
    "contact.formNamePlaceholder": "أدخل اسمك الكامل",
    "contact.formEmail": "البريد الإلكتروني",
    "contact.formEmailPlaceholder": "أدخل بريدك الإلكتروني",
    "contact.formPhone": "رقم الهاتف (اختياري)",
    "contact.formPhonePlaceholder": "أدخل رقم هاتفك",
    "contact.formMessage": "الرسالة",
    "contact.formMessagePlaceholder": "كيف يمكننا مساعدتك؟",
    "contact.formSubmit": "تجهيز البريد الإلكتروني",
    "contact.formNote": "يفتح هذا النموذج تطبيق البريد الإلكتروني ويوجه الرسالة إلى dr.saleemo@gmail.com.",
    "contact.formPrepared": "يجب أن يكون تطبيق البريد الإلكتروني جاهزاً الآن برسالتك.",
    ...
    "faq.a5": "لحجز المواعيد، استخدم نموذج الحجز في الموقع أو واتساب على 07507816500. للحالات العاجلة المتعلقة بالأسنان، اتصل على 07781665000 خلال ساعات عمل العيادة.",
  ...
  ku: {
    ...
    "hero.workingHoursValue": "ڕۆژانە ٣:٠٠ - ٩:٠٠ ئێوارە (جگە لە هەینی)",
    "hero.location": "شوێن",
    "hero.locationValue": "شەقامی قازی محەممەد، دهۆک",
    ...
    "contact.address": "شەقامی قازی محەممەد، دهۆک، پارێزگای دهۆک، ٤٢٠٠١، عێراق",
    "contact.workingHours": "کاتی کارکردن",
    "contact.workingHoursValue": "ڕۆژانە ٣:٠٠ - ٩:٠٠ ئێوارە (جگە لە هەینی)",
    "contact.whatsapp": "واتساپ و نۆرەدان",
    "contact.emergencyPhone": "هێڵی فریاکەوتنی ددان",
    "contact.emergencyNote": "بۆ بارودۆخێن لەناکاوی ددانی",
    ...
    "contact.formTitle": "پەیامێکمان بۆ بنێرە",
    "contact.formDescription": "فۆرمەکە پڕبکەوە و ئەپی ئیمەیڵەکەت پرسیارێک بۆ کلینیکەکەمان ئامادە دەکات.",
    "contact.formName": "ناوی تەواو",
    "contact.formNamePlaceholder": "ناوی تەواوت بنووسە",
    "contact.formEmail": "ناونیشانی ئیمەیڵ",
    "contact.formEmailPlaceholder": "ناونیشانی ئیمەیڵەکەت بنووسە",
    "contact.formPhone": "ژمارەی مۆبایل (ئارەزوومەندانە)",
    "contact.formPhonePlaceholder": "ژمارەی مۆبایلەکەت بنووسە",
    "contact.formMessage": "پەیام",
    "contact.formMessagePlaceholder": "چۆن دەتوانین یارمەتیت بدەین؟",
    "contact.formSubmit": "ئیمەیڵ ئامادە بکە",
    "contact.formNote": "ئەم فۆرمە ئەپی ئیمەیڵ دەکاتەوە و پەیامەکە بۆ dr.saleemo@gmail.com ئاراستە دەکات.",
    "contact.formPrepared": "ئەپی ئیمەیڵەکەت دەبێت ئێستا بە پەیامەکەت ئامادە بێت.",
    ...
    "faq.a5": "بۆ نۆرەدان، فۆرمی نۆرەی ماڵپەڕەکەمان یان واتساپ لە 07507816500 بەکاربهێنە. بۆ بارودۆخێن لەناکاوی ددانی، لە کاتی کارکردنی کلینیکەدا بە 07781665000 پەیوەندی بکە.",
